...
class AuthIntegrationTest {
    ...
    // Uses existing PostgreSQL from docker-compose
    // Note: Testcontainers has a known bug with Docker Desktop + WSL 2 where the API returns empty responses
    // To use testcontainers, try disabling "Use the WSL 2 based engine" in Docker Desktop settings
