...
public class UserController {
    ...
    public ResponseEntity<UserResponse> updateCurrentUser(
        ...
        User user = userRepository.findByEmail(userDetails.getUsername())
                .orElseThrow(() -> new AuthenticationFailedException("Authenticated user not found"));
        UserResponse response = userService.updateOwnProfile(user, request);
     ...
     */
    @DeleteMapping("/me")
    public ResponseEntity<UserResponse> deactivateCurrentUser(@AuthenticationPrincipal UserDetails userDetails) {
        User user = userRepository.findByEmail(userDetails.getUsername())
                .orElseThrow(() -> new AuthenticationFailedException("Authenticated user not found"));
